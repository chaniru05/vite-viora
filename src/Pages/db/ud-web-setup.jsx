...
// SIDEBAR COMPONENT
// ============================================
const Sidebar = ({ isOpen, setIsOpen, onNavigate, currentPage }) => {
  const menuItems = [
    { icon: Home, label: 'View Web Page', active: currentPage === 'view', page: 'view' },
    { icon: LayoutDashboard, label: 'Overview', active: currentPage === 'overview', page: 'overview' },
