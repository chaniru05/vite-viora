...
const stats = [
  { name: 'Happy Couples Served', value: '100+' },
  { name: 'Planning Checklists', value: '300+' },
  { name: 'Support Available', value: '24/7' },
  { name: 'Planning Guaranteed', value: 'Stress-Free' },
]
    ...
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      >
        <div
          ...
          className="aspect-1097/845 w-274.25 bg-linear-to-tr from-[#FFF8EF] to-[#C2BDAB] opacity-20"
        />
      </div>
      <div
        aria-hidden="true"
