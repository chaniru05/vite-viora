        ...
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8 text-center">
                ...
                <form action="#" method="POST" className="mt-6 max-w-md mx-auto">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700 mx-auto">Subscribe</button>
                </form>
            </div>
        </div>
